...
public class FTPPortNumberTest {
    ...
    public void ftpport_SetTo0_ValueShouldBe0(){
        ...
        assertOk(response);
        Utils.verifyResponse(response, "ftpport", "response contains ftpport");
        Utils.verifyResponse(Utils.sendRequest("/vb.htm?paratest=ftpport"), "ftpport=0", "ftpport value is 0");
    }
    ...
    public void ftpport_SetTo8442_ValueShouldBe8442(){
        ...
        assertOk(response);
        Utils.verifyResponse(response, "ftpport", "response contains ftpport");
        Utils.verifyResponse(Utils.sendRequest("/vb.htm?paratest=ftpport"), "ftpport=8442", "ftpport value is 8442");
    }
    ...
    public void ftpport_SetTo64000_ValueShouldBe64000(){
        ...
        assertOk(response);
        Utils.verifyResponse(response, "ftpport", "response contains ftpport");
        Utils.verifyResponse(Utils.sendRequest("/vb.htm?paratest=ftpport"), "ftpport=64000", "ftpport value is 64000");
    }
